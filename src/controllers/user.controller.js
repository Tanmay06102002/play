...
const registerUser = asyncHandler(async (req, res) => {
  ...
  5. upload images and avatar on cloudinary, double check for avatar
...
const loginUser = asyncHandler(async (req, res) => {
  ...
  3. find user
  4. if(user is there) check password
  5. genearate access and refresh token
...
const refreshAccessToken = asyncHandler(async (req, res) => {
  ...
  try {
    ...
    const { accessToken, newRefreshToken } =
      await genearateAccessAndRefreshToken(user._id);
